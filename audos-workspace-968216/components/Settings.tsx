...
export default function Settings({ spaceId }: SettingsProps) {
  ...
  const getStatusBadge = () => {
    ...
    switch (subscriptionStatus.status) {
      case 'active':
        return (
          <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium ${subscriptionStatus.cancelAtPeriodEnd ? 'bg-[var(--space-surface-muted)] text-[var(--space-semantic-warning)]' : 'bg-[var(--space-surface-muted)] text-[var(--space-semantic-success)]'}`}>
      ...
      case 'trialing':
        return (
          <div className="flex items-center gap-1.5 px-3 py-1.5 bg-[var(--space-surface-muted)] text-[var(--space-text-brand)] rounded-full text-sm font-medium">
      ...
      case 'trial_expired':
        return (
          <div className="flex items-center gap-1.5 px-3 py-1.5 bg-[var(--space-surface-muted)] text-[var(--space-semantic-warning)] rounded-full text-sm font-medium">
      ...
      case 'past_due':
        return (
          <div className="flex items-center gap-1.5 px-3 py-1.5 bg-[var(--space-surface-muted)] text-[var(--space-semantic-danger)] rounded-full text-sm font-medium">
            <AlertCircle className="w-4 h-4" />
            Payment past due
          </div>
        );
      ...
      <div className={settingsStyles.innerContainer}>
        ...
        <div className={settingsStyles.section}>
          <div className="flex items-center justify-between mb-4">
            ...
            {email && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-[var(--space-text-secondary)] hover:text-[var(--space-semantic-danger)] hover:bg-[var(--space-surface-muted)] rounded-lg transition-colors"
          ...
          <div>
            ...
            {portalMessage && (
              <p className="text-sm text-[var(--space-semantic-success)]" role="status">
                {portalMessage}
              </p>
            )}
          </div>
            ...
            {statusLoading ? (
              ...
              <div className="space-y-4">
                ...
                {(subscriptionStatus?.status === 'trial' || subscriptionStatus?.status === 'trialing') && (
                  <div className="p-4 bg-[var(--space-surface-muted)] rounded-xl border border-[var(--space-border-strong)]">
                    ...
                    <div className="w-full h-2 bg-[var(--space-border-strong)] rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-gradient-to-r from-[var(--space-brand-highlight)] to-[var(--space-brand-primary)] rounded-full transition-all"
                        style={{ 
                    ...
                    {subscriptionStatus.hasPaymentMethod && (
                      <button
                        ...
                        className="mt-3 flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-[var(--space-text-secondary)] hover:text-[var(--space-text-primary)] hover:bg-[var(--space-surface-card-hover)] border border-[var(--space-border-strong)] rounded-lg transition-colors disabled:opacity-50"
                      >
                        {managingPortal ? (
                ...
                {subscriptionStatus?.status === 'active' && (
                  <div className={`p-4 bg-[var(--space-surface-muted)] ${subscriptionStatus.cancelAtPeriodEnd ? 'border-[var(--space-semantic-warning)]' : 'border-[var(--space-semantic-success)]'} rounded-xl border`}>
                    {subscriptionStatus.cancelAtPeriodEnd ? (
                      <>
                        <div className="flex items-center gap-2">
                          <CalendarX className="w-5 h-5 text-[var(--space-semantic-warning)]" />
                          <span className="text-sm font-medium text-[var(--space-text-primary)]">
                            Subscription ending
                          </span>
                        </div>
                      ...
                      <>
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="w-5 h-5 text-[var(--space-semantic-success)]" />
                          <span className="text-sm font-medium text-[var(--space-text-primary)]">
                    ...
                    <button
                      onClick={handleManageSubscription}
                      disabled={managingPortal}
                      className="mt-3 flex items-center gap-2 px-4 py-2 text-sm font-medium text-[var(--space-text-primary)] bg-[var(--space-surface-card)] hover:bg-[var(--space-surface-card-hover)] border border-[var(--space-border-strong)] rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {managingPortal ? (
                        <>
                          <Loader2 className="w-4 h-4 animate-spin" />
                ...
                {subscriptionStatus?.status === 'trial_expired' && (
                  <div className="p-4 bg-[var(--space-surface-muted)] rounded-xl border border-[var(--space-semantic-warning)]">
                    <div className="flex items-center gap-2">
                      <AlertCircle className="w-5 h-5 text-[var(--space-semantic-warning)]" />
                      <span className="text-sm font-medium text-[var(--space-text-primary)]">
                ...
                {showPaymentCTA && (
                  <div className="space-y-3">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-[var(--space-brand-primary)] hover:bg-[var(--space-brand-primary-700)] text-[var(--space-text-on-primary)] font-medium rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
